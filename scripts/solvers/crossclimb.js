...
const solveCrossclimb = async () => {
  ...
  console.log(document.querySelector("input#ember46"));
  const draggable = elements[4].querySelector(
    ".crossclimb__guess-dragger.crossclimb__guess-dragger__left",
  );
  simulateClick(draggable);
  await sleep(100);
};
